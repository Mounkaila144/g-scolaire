...
const EditModal = ({ open, setOpen ,setSuccess, setLoading,setError}) => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await MyRequest('register', 'POST', formData, {'Content-Type': 'application/json'});
