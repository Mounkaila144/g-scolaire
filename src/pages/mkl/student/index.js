...
const studentList = () => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      <EditModal data={datastudent} open={openedit} setOpen={setOpenedit} setSuccess={setSuccess} setLoading={setLoading} setError={setError}/>
      <ViewModal data={datastudent} open={openview} setOpen={setOpenview} setSuccess={setSuccess} setLoading={setLoading} setError={setError}/>
      {/* View user modal */}
      <Dialog
        fullWidth
        open={success}
