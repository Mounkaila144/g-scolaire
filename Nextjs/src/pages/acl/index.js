      ...
      <Grid item md={6} xs={12}>
        <Card>
          ...
          <CardContent>
            ...
            <Typography sx={{ color: 'primary.main' }}>This card is visible to 'user' and 'superadmin' both</Typography>
          </CardContent>
        </Card>
      </Grid>
        ...
        <Grid item md={6} xs={12}>
          <Card>
            ...
            <CardContent>
              ...
              <Typography sx={{ color: 'error.main' }}>This card is visible to 'superadmin' only</Typography>
            </CardContent>
          </Card>
        </Grid>
      ) : null}
