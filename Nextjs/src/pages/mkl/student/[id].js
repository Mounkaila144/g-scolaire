...
import ScolaireModal from "../../../components/eleves/scolaire";
...
const Student = () => {
  ...
  const [openscolaire, setOpenscolaire] = useState(false)
...
console.log(id)
  ...
  return (
      ...
      <ScolaireModal  id={id}  data={dataUser} open={openscolaire} setOpen={setOpenscolaire} setSuccess={setSuccess} setLoading={setLoading} setError={setError}/>
       {/*View user modal */}
